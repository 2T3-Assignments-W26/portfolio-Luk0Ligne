...
### Tech Used:
This programs structure is much more organized than the previous one and uses more methods for clearer understanding of what is going on. It uses alot of arrays, case switches and string interpolation.
### Code Snippets:
